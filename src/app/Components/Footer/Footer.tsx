    ...
    <footer className="footer">
      ...
      <div className="footer-container">
        <div className="footer-column">
          ...
          <p>
            LumiReel — A premium film platform.
            Watch the latest and highest-quality
            movies, curated for film lovers!
          </p>
        </div>
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li>
              <Link href="/main/premium">
                About Premium
              </Link>
            </li>

            <li>
              <Link href="/main/securty">
                Account Security
              </Link>
            </li>
      ...
      <div className="footer-bottom">
        <p className="neon-text">
          © 2025 LumiReel. All rights reserved.
        </p>
      </div>
    </footer>
  );
